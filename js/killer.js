document.addEventListener('DOMContentLoaded', function() {
    const backgroundImage = document.getElementById('kill');
    const whisper = document.getElementById('sirenhead');
    ...
    document.getElementById('question-form').addEventListener('submit', function(event) {
        ...
        if (selectedKill === 'yes') {
            ...
            window.location.href = `exit.html?kill=${encodeURIComponent(selectedKill)}&volume=${volume}`;
        } else {
